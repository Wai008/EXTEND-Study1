...
linear_scale1 <- round(rescale(sum_all_var$sum_positive, to = c(0, 100))) 

linear_scale2 <- round(rescale(sum_all_var$sum_negative, to = c(0, 100))) 

linear_scale3 <- round(rescale(sum_all_var$sum_concerns, to = c(0, 100))) 

linear_scale4 <- round(rescale(sum_all_var$sum_redflag, to = c(0, 100))) 
