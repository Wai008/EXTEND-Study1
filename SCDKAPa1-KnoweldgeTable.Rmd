...
SCDKAPa1$totalcorrect <- SCDKAPa1$totalcorrect + ifelse(SCDKAPa1$complscdpeds_ng == "e", 1, 0)
...
SCDKAPa1$compcorrect <- SCDKAPa1$compcorrect + ifelse(SCDKAPa1$complscdpeds_ng == "e", 1, 0)
